...
namespace vuapos.Presentation.Views.Category
{
    ...
    public sealed partial class CategoryPage : UserControl
    {
            ...
            try
            {
                ...
                if (sender is Button button && button.DataContext is Category category)
                {
                    ...
                    while (true)
                    {
                        ...
                        {
                            Debug.WriteLine($"Error updating category: {ex.Message}, You do not have permission.");
        ...
        private async void DeleteCategory_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                if (sender is Button button && button.DataContext is Category category)
                {
                    ...
                    if (result == ContentDialogResult.Primary)
                    {
                        var s = await ViewModel.DeleteCategoryAsync(category);
                        if (!s)
        ...
        private async void AddCategory_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                await ShowErrorDialogAsync($"Failed to add product: {ex.Message}");
            }
